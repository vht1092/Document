--------------------------------------------------------
--  DDL for Function FN_FDS_RULE35_V3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "CCPS"."FN_FDS_RULE35_V3" 
/**********************************************************************************
...
BEGIN
    ...
    IF p_ref_cde LIKE '%28%' AND p_ref_cde NOT LIKE '%10%' AND p_ref_cde NOT LIKE '%35%' AND (V_BIN = '489518' OR V_BIN = '554627') THEN
        L_CHECK_POINT := 2;
