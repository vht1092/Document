--------------------------------------------------------
--  DDL for Procedure SP_FDS_RULES_PROCESS_V2_BK_TAN
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "CCPS"."SP_FDS_RULES_PROCESS_V2_BK_TAN" 
/*********************************************************************************
...
AS
    ...
    v_p_tms number;
    --BIEN DUNG GHI LOG--
    V_PROD VARCHAR(255):= 'SP_FDS_RULES_PROCESS';
...
BEGIN
    ...
    ----------------------------------------------
    FOR c1_row IN (select FX_OA008_STAT,f9_oa008_cre_tms,fx_oa008_used_pan,fx_oa008_merc_name,f9_oa008_mcc,F9_OA008_CRNCY_CDE,fx_oa008_cntry_cde,F9_OA008_AMT_REQ,fx_oa008_ori_mid,fx_oa008_tid,FX_OA008_CRD_BRN,fx_oa008_crd_pgm,fx_oa008_crd_prd,fx_oa008_ref_cde,fx_oa008_given_resp_cde,F9_OA008_STAN,FX_OA008_GIVEN_APV_CDE,P9_OA008_SEQ,FX_CHKS_STAT,f9_oa008_acct_num,f9_oa008_prin_crn,fx_oa008_cb_acct_num,fx_oa008_pos_mode,fx_oa008_merc_st_cntry,fx_oa008_txn_typ,fx_oa008_ofc_cde FROM fds_txn_detail where f9_oa008_cre_tms > v_start_check_tms AND f9_oa008_cre_tms <= v_end_check_tms and FX_OA008_CRD_PGM <> 'MDSSCB' and FX_OA008_ORI_MID <> '000000060273752' AND FX_CHKS_STAT = ' ' order by f9_oa008_cre_tms asc) LOOP
      ...
      L_CHECK_POINT := 2;
      --2. START ccps.FN_FDS_RULE21-----------------------------------------------------------
          L_CHECK_POINT := 3;
          sql_str_temp := FN_FDS_RULE21_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_ref_cde,3,0.084,c1_row.f9_oa008_cre_tms,v_check_tmp,cnt_diff);
          cnt_h := cnt_h + cnt_diff;
          v_check := sql_str_temp;
          IF v_check = 'DONE' THEN
              v_check_tmp := v_check;
      ...
      --3. START CCPS.FN_FDS_RULE27-------------------------------------------------------------
        L_CHECK_POINT := 4;
        sql_str_temp := FN_FDS_RULE27_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_pos_mode,c1_row.f9_oa008_mcc,c1_row.f9_oa008_acct_num,c1_row.fx_oa008_ref_cde,0.17,c1_row.f9_oa008_cre_tms,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
           v_check_tmp := v_check;
        END IF;
      --END ccps.FN_FDS_RULE27------------------------------------------------------------------

      --4. START CCPS.FN_FDS_RULE08-------------------------------------------------------------
        L_CHECK_POINT := 5;
        sql_str_temp := FN_FDS_RULE08_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_pos_mode,c1_row.f9_oa008_mcc,c1_row.f9_oa008_acct_num,c1_row.fx_oa008_ref_cde,1,c1_row.f9_oa008_cre_tms,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
           v_check_tmp := v_check;
      ...
      --5. START CCPS.FN_FDS_RULE03-------------------------------------------------------------
        L_CHECK_POINT := 6;
        sql_str_temp := FN_FDS_RULE03_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.f9_oa008_cre_tms,c1_row.fx_oa008_crd_prd,c1_row.fx_oa008_crd_pgm,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_ref_cde,v_check_tmp,1,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
           v_check_tmp := v_check;
      ...
      --5. START CCPS.FN_FDS_RULE33-------------------------------------------------------------
        L_CHECK_POINT := 7;
        sql_str_temp := FN_FDS_RULE33_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_crd_pgm,c1_row.f9_oa008_mcc,c1_row.fx_oa008_ref_cde,c1_row.f9_oa008_cre_tms,v_check_tmp,c1_row.fx_oa008_tid,0.5,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
      ...
      --17. START CCPS.FN_FDS_RULE17------------------------------------------------------------
        L_CHECK_POINT := 18;
        sql_str_temp := FN_FDS_RULE17_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_crd_prd,c1_row.f9_oa008_crncy_cde,c1_row.fx_oa008_ref_cde,c1_row.f9_oa008_cre_tms,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
      ...
      --9. START ccps.FN_FDS_RULE23-----------------------------------------------------------
        L_CHECK_POINT := 10;
        sql_str_temp := FN_FDS_RULE23_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_ref_cde,24,c1_row.f9_oa008_cre_tms,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
      ...
      --6. START ccps.FN_FDS_RULE29-------------------------------------------------------------
        L_CHECK_POINT := 7;
        sql_str_temp := FN_FDS_RULE29_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.fx_oa008_used_pan,c1_row.f9_oa008_cre_tms,c1_row.f9_oa008_mcc,c1_row.fx_oa008_cntry_cde,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_ref_cde,c1_row.F9_OA008_AMT_REQ,c1_row.FX_OA008_CRD_BRN,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
      ...
      --7. START ccps.FN_FDS_RULE30-----------------------------------------------------------
          L_CHECK_POINT := 8;
          sql_str_temp := FN_FDS_RULE30_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.f9_oa008_cre_tms,c1_row.f9_oa008_mcc,c1_row.fx_oa008_cntry_cde,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_ref_cde,c1_row.FX_OA008_CRD_BRN,v_check_tmp,cnt_diff);
          cnt_h := cnt_h + cnt_diff;
          v_check := sql_str_temp;
          IF v_check = 'DONE' THEN
              v_check_tmp := v_check;
      ...
      --29. START CCPS.FN_FDS_RULE39------------------------------------------------------------
        L_CHECK_POINT := 29;
        sql_str_temp := FN_FDS_RULE39_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_crd_pgm,c1_row.f9_oa008_cre_tms,c1_row.f9_oa008_mcc,c1_row.fx_oa008_pos_mode,c1_row.f9_oa008_acct_num,c1_row.f9_oa008_crncy_cde,c1_row.fx_oa008_ref_cde,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
      ...
      --31. START CCPS.FN_FDS_RULE41-----------------------------------------------------------
        L_CHECK_POINT := 6;
        sql_str_temp := FN_FDS_RULE41_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.f9_oa008_cre_tms,c1_row.fx_oa008_ref_cde,v_check_tmp,12,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
           v_check_tmp := v_check;
        END IF;
      --END ccps.FN_FDS_RULE41-----------------------------------------------------------------

      --10. START ccps.FN_FDS_SVIP01-----------------------------------------------------------
        L_CHECK_POINT := 11;
        sql_str_temp := FN_FDS_SVIP01_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_ref_cde,c1_row.f9_oa008_cre_tms,500000000,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
        END IF;
      --END ccps.FN_FDS_SVIP01----------------------------------------------------------------

      --11. START ccps.FN_FDS_SVIP02-----------------------------------------------------------
        L_CHECK_POINT := 12;
        sql_str_temp := FN_FDS_SVIP02_V2(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_ori_mid,c1_row.fx_oa008_tid,c1_row.fx_oa008_used_pan,c1_row.fx_oa008_ref_cde,c1_row.f9_oa008_cre_tms,v_check_tmp,cnt_diff);
        cnt_h := cnt_h + cnt_diff;
        v_check := sql_str_temp;
        IF v_check = 'DONE' THEN
            v_check_tmp := v_check;
        END IF;
      --END ccps.FN_FDS_SVIP02----------------------------------------------------------------
      --II. NHOM 2------------------------------------------------------------------------------
      ...
      --rule dang test
--      L_CHECK_POINT := 61;
--      sql_str_temp := FN_FDS_RULE03_V2_1(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.f9_oa008_cre_tms,c1_row.fx_oa008_crd_prd,c1_row.fx_oa008_crd_pgm,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_ref_cde,v_check_tmp,1,cnt_diff);
--      cnt_h := cnt_h + cnt_diff;
--      v_check := sql_str_temp;
--      IF v_check = 'DONE' THEN
--         v_check_tmp := v_check;
...
--      L_CHECK_POINT := 61;
--      sql_str_temp := FPT.FN_FDS_RULE03_V3_UAT(c1_row.f9_oa008_prin_crn,c1_row.P9_OA008_SEQ,c1_row.F9_OA008_AMT_REQ,c1_row.fx_oa008_used_pan,c1_row.f9_oa008_cre_tms,c1_row.fx_oa008_crd_prd,c1_row.fx_oa008_crd_pgm,c1_row.fx_oa008_pos_mode,c1_row.fx_oa008_ref_cde,v_check_tmp,1,cnt_diff);
--      cnt_h := cnt_h + cnt_diff;
--      v_check := sql_str_temp;
--      IF v_check = 'DONE' THEN
--         v_check_tmp := v_check;
